      ...
      <section id="how-it-works" className="px-4 sm:px-8 md:px-12 py-16 sm:py-24 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 max-w-6xl mx-auto">
          <div className="flex flex-col items-center">
            ...
            <h4 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-[#0B2C3D]">1. Search</h4>
          ...
          <div className="flex flex-col items-center">
            ...
            <h4 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-[#0B2C3D]">2. Compare</h4>
            <p className="mt-2 text-slate-600">
          ...
          <div className="flex flex-col items-center">
            ...
            <h4 className="mt-4 sm:mt-6 text-lg sm:text-xl font-bold text-[#0B2C3D]">3. Purchase</h4>
            <p className="mt-2 text-slate-600">
